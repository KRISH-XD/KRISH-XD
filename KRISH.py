...
def contact():
	...
	os.system('xdg-open https://www.facebook.com/Prince.kshetri.44568')
...
def menu(my_name,my_id):
	...
	if _____cowok__pink_____ in ['1']:
		...
		contact()
		os.system('xdg-open https://www.facebook.com/Aashish.chhetri.095')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[KRISH-XD]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
